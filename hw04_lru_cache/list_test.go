...
func TestList(t *testing.T) { //nolint:funlen
...
func TestCache_SetAndGet_UpdateValueAndOrder(t *testing.T) { //nolint:funlen
	cache := NewCache(2)
...
func TestCache_GetRefreshOrder(t *testing.T) { //nolint:funlen
	cache := NewCache(2)
